...
// Ensure, that MessageChainTrackerMock does implement MessageChainTracker.
// If this is not the case, regenerate this file with moq.
var _ MessageChainTracker = &MessageChainTrackerMock{}

// MessageChainTrackerMock is a mock implementation of MessageChainTracker.
//
//	func TestSomethingThatUsesMessageChainTracker(t *testing.T) {
//
//		// make and configure a mocked MessageChainTracker
//		mockedMessageChainTracker := &MessageChainTrackerMock{
//			AddMessageFunc: func(ctx context.Context, msg *InternalMessage) (string, error) {
//				panic("mock out the AddMessage method")
//			},
//			IsRelatedFunc: func(ctx context.Context, msg *InternalMessage) bool {
//				panic("mock out the IsRelated method")
//			},
//			ReleaseMessageFunc: func(ctx context.Context, msg *InternalMessage) error {
//				panic("mock out the ReleaseMessage method")
//			},
//		}
//
//		// use mockedMessageChainTracker in code that requires MessageChainTracker
//		// and then make assertions.
//
//	}
type MessageChainTrackerMock struct {
	// AddMessageFunc mocks the AddMessage method.
	AddMessageFunc func(ctx context.Context, msg *InternalMessage) (string, error)

	// IsRelatedFunc mocks the IsRelated method.
	IsRelatedFunc func(ctx context.Context, msg *InternalMessage) bool

	// ReleaseMessageFunc mocks the ReleaseMessage method.
	ReleaseMessageFunc func(ctx context.Context, msg *InternalMessage) error
	...
	calls struct {
		...
		// IsRelated holds details about calls to the IsRelated method.
		IsRelated []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// Msg is the msg argument value.
		...
		// ReleaseMessage holds details about calls to the ReleaseMessage method.
		ReleaseMessage []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// Msg is the msg argument value.
			Msg *InternalMessage
	...
	lockIsRelated      sync.RWMutex
	lockReleaseMessage sync.RWMutex
}

// AddMessage calls AddMessageFunc.
func (mock *MessageChainTrackerMock) AddMessage(ctx context.Context, msg *InternalMessage) (string, error) {
	if mock.AddMessageFunc == nil {
		panic("MessageChainTrackerMock.AddMessageFunc: method is nil but MessageChainTracker.AddMessage was just called")
	}
	callInfo := struct {
		Ctx context.Context
		Msg *InternalMessage
	...
	return mock.AddMessageFunc(ctx, msg)
}

// AddMessageCalls gets all the calls that were made to AddMessage.
// Check the length with:
//
//	len(mockedMessageChainTracker.AddMessageCalls())
func (mock *MessageChainTrackerMock) AddMessageCalls() []struct {
	Ctx context.Context
	Msg *InternalMessage
} {
	var calls []struct {
...
// IsRelated calls IsRelatedFunc.
func (mock *MessageChainTrackerMock) IsRelated(ctx context.Context, msg *InternalMessage) bool {
	if mock.IsRelatedFunc == nil {
		panic("MessageChainTrackerMock.IsRelatedFunc: method is nil but MessageChainTracker.IsRelated was just called")
	}
	callInfo := struct {
		Ctx context.Context
		Msg *InternalMessage
	...
	mock.lockIsRelated.Lock()
	mock.calls.IsRelated = append(mock.calls.IsRelated, callInfo)
	mock.lockIsRelated.Unlock()
	return mock.IsRelatedFunc(ctx, msg)
}

// IsRelatedCalls gets all the calls that were made to IsRelated.
// Check the length with:
//
//	len(mockedMessageChainTracker.IsRelatedCalls())
func (mock *MessageChainTrackerMock) IsRelatedCalls() []struct {
	Ctx context.Context
	Msg *InternalMessage
} {
	var calls []struct {
	...
	mock.lockIsRelated.RLock()
	calls = mock.calls.IsRelated
	mock.lockIsRelated.RUnlock()
	return calls
}

// ReleaseMessage calls ReleaseMessageFunc.
func (mock *MessageChainTrackerMock) ReleaseMessage(ctx context.Context, msg *InternalMessage) error {
	if mock.ReleaseMessageFunc == nil {
		panic("MessageChainTrackerMock.ReleaseMessageFunc: method is nil but MessageChainTracker.ReleaseMessage was just called")
	}
	callInfo := struct {
		Ctx context.Context
		Msg *InternalMessage
	...
	mock.lockReleaseMessage.Lock()
	mock.calls.ReleaseMessage = append(mock.calls.ReleaseMessage, callInfo)
	mock.lockReleaseMessage.Unlock()
	return mock.ReleaseMessageFunc(ctx, msg)
}

// ReleaseMessageCalls gets all the calls that were made to ReleaseMessage.
// Check the length with:
//
//	len(mockedMessageChainTracker.ReleaseMessageCalls())
func (mock *MessageChainTrackerMock) ReleaseMessageCalls() []struct {
	Ctx context.Context
	Msg *InternalMessage
} {
	var calls []struct {
	...
	mock.lockReleaseMessage.RLock()
	calls = mock.calls.ReleaseMessage
	mock.lockReleaseMessage.RUnlock()
	return calls
}
